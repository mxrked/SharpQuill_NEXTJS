    ...
    <div className={styles.type_species}>
      ...
      >
        <div className={`${styles.type_togglers_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/mesechinus/daurian.jpg"
              width="100%"
              height="100%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/mesechinus/gaoligong-forest.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/mesechinus/hughs.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
