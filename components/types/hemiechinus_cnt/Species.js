    ...
    <div className={styles.type_species}>
      ...
      >
        <div className={`${styles.type_togglers_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/hemiechinus/indian-long-eared.jpg"
              width="100%"
              height="100%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/hemiechinus/long-eared.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
