    ...
    <div className={styles.type_species}>
      ...
      >
        <div className={`${styles.type_togglers_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/atelerix/four-toed.jpg"
              width="100%"
              height="100%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/atelerix/north-african.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/atelerix/southern-african.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/atelerix/somali.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
