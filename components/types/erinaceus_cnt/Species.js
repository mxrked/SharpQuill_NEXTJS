    ...
    <div className={styles.type_species}>
      ...
      >
        <div className={`${styles.type_togglers_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/erinaceus/amur.jpg"
              width="100%"
              height="100%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/erinaceus/european.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/erinaceus/northern-white-breasted.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/erinaceus/southern-white-breasted.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
