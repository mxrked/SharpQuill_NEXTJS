    ...
    <div className={styles.type_species}>
      ...
      >
        <div className={`${styles.type_togglers_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/paraechinus/bare-bellied.jpg"
              width="100%"
              height="100%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/paraechinus/brandts.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/paraechinus/desert.png"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/paraechinus/indian.jpg"
              width="100%"
              height="100%"
              className={styles.modal_toggler_bg}
            >
