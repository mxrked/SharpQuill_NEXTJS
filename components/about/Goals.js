        ...
        <div className={`${styles.goals_main_row} row`}>
          ...
          >
            <div className={styles.goals_main_side_cnt}>
              <img
                data-src="http://basicallyeasy.com/NextJSCDNS/sharpquill/info/goal-1.png"
          ...
          >
            <div className={styles.goals_main_side_cnt}>
              <img
                data-src="http://basicallyeasy.com/NextJSCDNS/sharpquill/info/goal-2.png"
                className="lazyload blur-up"
                alt="Open Book Icon"
              />
          ...
          >
            <div className={styles.goals_main_side_cnt}>
              <img
                data-src="http://basicallyeasy.com/NextJSCDNS/sharpquill/info/goal-3.png"
                className="lazyload blur-up"
                alt="Hedgehog Icon"
              />
