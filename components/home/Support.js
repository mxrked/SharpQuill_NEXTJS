    ...
    <div className={styles.support}>
      ...
      >
        <div className={`${styles.support_main_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/support/support-contact-bg.jpg"
              width="100%"
              height="100%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/support/support-policies-bg.jpg"
              width="100%"
              height="100%"
              className={`${styles.support_background_img} support_bg`}
            />
