    ...
    <div className={styles.types}>
      ...
      >
        <div className={`${styles.types_main_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/atelerix/atelerix-type.jpg"
              width="100%"
              height="100%"
        ...
        <div className={`${styles.types_main_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/sharpquill/types/paraechinus/paraechinus-type.jpg"
              width="100%"
              height="100%"
              className={`${styles.background_img} types_bg`}
            ></BackgroundImage>
