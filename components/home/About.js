        ...
        <div className={`${styles.about_main_row} row`}>
          ...
          >
            <div className={styles.about_main_side_cnt}>
              <BackgroundImage
                src="http://basicallyeasy.com/NextJSCDNS/sharpquill/info/info-background-1.jpg"
                width="100%"
                height="100%"
              ...
              />
              <BackgroundImage
                src="http://basicallyeasy.com/NextJSCDNS/sharpquill/info/info-background-2.jpg"
                width="100%"
                height="100%"
                className={styles.about_main_side_cnt_bg}
