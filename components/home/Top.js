  ...
  render() {
    ...
    return (
      <div id={styles.indexTop}>
        <Slider {...iTopSettings}>
          <BackgroundImage
            src="http://basicallyeasy.com/NextJSCDNS/sharpquill/index/top/index-top-3.jpg"
            width="100%"
            height="100%"
          ...
          >
            <this.createIndexTopSlideTxt
              ...
              indexTopSlideTO="/next-projects/sharpquills/types/"
            />
          </BackgroundImage>
          <BackgroundImage
            src="http://basicallyeasy.com/NextJSCDNS/sharpquill/index/top/index-top-2.jpg"
            width="100%"
            height="100%"
            className={styles.index_top_slide}
            id={styles.iTopS2}
          >
            <this.createIndexTopSlideTxt
              ...
              indexTopSlideTO="/next-projects/sharpquills/about/"
            />
          </BackgroundImage>
          <BackgroundImage
            src="http://basicallyeasy.com/NextJSCDNS/sharpquill/index/top/index-top-1.jpg"
            width="100%"
            height="100%"
            className={styles.index_top_slide}
            id={styles.iTopS3}
          >
            <this.createIndexTopSlideTxt
              ...
              indexTopSlideTO="/next-projects/sharpquills/adopt/"
            />
          </BackgroundImage>
        </Slider>
      </div>
